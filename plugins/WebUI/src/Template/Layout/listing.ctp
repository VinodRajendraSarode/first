		...
		<footer class="footer-section">
			<div class="container relative">
				...
				<div class="sofa-img">
					...
					<?= $this->Html->image('sofa.png', ['class'=>"img-fluid"]); ?>
				</div>

				<div class="row">
					<div class="col-lg-8">
						<div class="subscription-form">
							<h3 class="d-flex align-items-center"><span class="me-1"><?= $this->Html->image('envelope-outline.svg', ['class'=>"img-fluid"]); ?> </span><span>Subscribe to Newsletter</span></h3>
