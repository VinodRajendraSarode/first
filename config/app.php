...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '06d2418055b208d76f3954796ae4f14dce32ae475b7f24e7bcf0e73e43b6288777'),
    ],
    ...
    'EmailTransport' => [
        'default' => [
            ...
            'from' => array(env('EMAIL_FROM', null) => env('EMAIL_FROM_NAME', null)),
            'replyTo' => array(env('EMAIL_REPLY_TO', null) => env('EMAIL_REPLY_TO_NAME', null)),
    ...
    'Email' => [
        'default' => [
            'transport' => 'default',
            'from' => array('info@rentzopidiea.com'=>'Rentzopiedia'),
            'replyTo' => array('info@rentzopidiea.com'=>'Rentzopiedia'),
            //'charset' => 'utf-8',
            //'headerCharset' => 'utf-8',
        ],
    ],
