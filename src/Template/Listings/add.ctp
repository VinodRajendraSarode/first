		...
		$("#category-id").on("change", function(){
			...
			$.ajax({
				...
				<?php if(!empty($listings->sub_category_id)) { ?>
					$('#sub-category-id').val("<?php echo $listings['subCategory']['id']; ?>");
				<?php } ?>
			});
		});
    ...
    <fieldset>
		<div class="row">
			<div class="col-md-6">
				...
				<?php echo  $this->Form->control('category_id',['empty'=>'(Choose One)', 'options'=>$categories]);  ?>
			</div>
			<div class="col-md-6">
		...
		<div class="row">
			<div class="col-md-12">
				<?php echo $this->Form->control('address',['label'=>"Address*"]); ?>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
		...
		<div class="row">
			<div class="col-md-12">
				<?php echo $this->Form->control('google_location',['label'=>"Google Location"]); ?>
		...
		<div class="row">
			<div class="col-md-3">
				<?php echo $this->Form->control('hourly_rate',['label'=>"Hourly Rate*"]); ?>
			</div>
			<div class="col-md-3">
				<?php echo $this->Form->control('daily_rate',['label'=>"Daily Rate"]); ?>
			</div>
			<div class="col-md-3">
				<?php echo $this->Form->control('currency',['options'=>$currency,'label'=>"Currency",'empty'=>true]); ?>
			</div>
