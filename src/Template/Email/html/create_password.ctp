				...
				<tbody>
					<tr>
						<td>
							...
							<p>Kindly create your own password to access "My Dominion 2".</p>
							<p> <a href="<?php echo $reset_token_link; ?>" style="display: inline-block; padding: 10px 30px; font-size: 14px; color: #fff; background: #f44236; border-radius: 40px; text-decoration:none;">Create Password</a></p>
